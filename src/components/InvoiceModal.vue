    ...
    <div @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-column">
        <form @submit.prevent="submitForm" class="invoice-content">
            ...
            <div class="bill-to flex flex-column">
                ...
                <div class="input flex flex-column">
                    <label for="billerCity">Client's Email</label>
            ...
            <div class="invoice-work flex flex-column">
                ...
                <div class="work-items">
                    ...
                    <div @click="addNewInvoice" class="flex button">
                        <img src="../assets/icon-plus.svg" alt="addItem">
                        Add new Item
                    </div>
                </div>
            </div>
...
export default {
    ...
    created() {
        ...
        this.invoiceDate = new Date(this.invoiceDateUnix).toLocaleTimeString("en-us", this.dateOptions)
    }
}
</script>
